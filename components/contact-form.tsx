...
export default function ContactForm({ isOpen, onClose, onSubmit, contact }: ContactFormProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Form Container */}
      <div className="relative w-full max-w-lg p-6 bg-white border border-slate-200 rounded-xl shadow-xl z-10 overflow-y-auto max-h-[90vh] animate-in fade-in zoom-in-95 duration-200">
        <button 
          onClick={onClose}
