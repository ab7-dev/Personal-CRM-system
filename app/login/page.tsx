...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    // Mock login delay and redirection
      ...
      <div className="w-full max-w-md space-y-8 bg-white p-8 border border-slate-200 rounded-xl shadow-sm relative">
        ...
        <div className="grid grid-cols-2 gap-3 mt-6">
          <button
            ...
            className="flex items-center justify-center gap-2 px-3 py-2 text-xs font-semibold text-slate-700 bg-white border border-slate-200 hover:bg-slate-50 rounded-lg transition"
          >
          ...
          >
            ...
            <svg className="w-3.5 h-3.5" viewBox="0 0 24 24">
              <path
                fill="#EA4335"
                d="M12.24 10.285V14.4h6.887c-.648 2.41-2.519 4.114-5.136 4.114-3.478 0-6.3-2.822-6.3-6.3s2.822-6.3 6.3-6.3c1.706 0 3.2.665 4.31 1.74l3.14-3.14C19.262 2.505 15.986 1.5 12.24 1.5c-5.79 0-10.5 4.71-10.5 10.5s4.71 10.5 10.5 10.5c5.385 0 9.85-3.878 9.85-10.5 0-.585-.05-1.17-.15-1.715H12.24z"
              />
            </svg>
            <span>Google</span>
          </button>
